...
j=1
source("rainfed/input_rain_paleo.R",echo=TRUE)
if(fertilization==0){
fert=3:4
} else {
if(fertilization==1) {
...
#source("rainfed/wls_rain.R",echo=F)
...
j=0
source("rainfed/aggregate.R",echo=F)
} else {
crop=cbind(prediction1,prediction2,prediction3,prediction4,prediction5,prediction6,prediction7,prediction8,prediction9,prediction10,prediction11)
